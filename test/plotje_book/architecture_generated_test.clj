    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__89770#] (= :petal-length (:x p1__89770#)))
        layers)
       (every?
        (fn* [p1__89771#] (= :petal-width (:y p1__89771#)))
        layers)
       (every?
        (fn* [p1__89772#] (= :species (:color p1__89772#)))
        layers)))
     (= {} (:opts d))))
   v14_l205)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__89773#]
       (.startsWith (.getName (class p1__89773#)) "membrane.ui."))
      (:drawables v))))
   v27_l263)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__89774#] (.startsWith p1__89774# "rgb"))
         (:colors s)))))))
   v42_l507)))
