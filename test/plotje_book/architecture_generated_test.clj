    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__96171#] (= :petal-length (:x p1__96171#)))
        layers)
       (every?
        (fn* [p1__96172#] (= :petal-width (:y p1__96172#)))
        layers)
       (every?
        (fn* [p1__96173#] (= :species (:color p1__96173#)))
        layers)))
     (= {} (:opts d))))
   v14_l201)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__96174#]
       (.startsWith (.getName (class p1__96174#)) "membrane.ui."))
      (:drawables v))))
   v27_l259)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__96175#] (.startsWith p1__96175# "rgb"))
         (:colors s)))))))
   v42_l503)))
