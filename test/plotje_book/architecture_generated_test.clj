    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__81049#] (= :petal-length (:x p1__81049#)))
        layers)
       (every?
        (fn* [p1__81050#] (= :petal-width (:y p1__81050#)))
        layers)
       (every?
        (fn* [p1__81051#] (= :species (:color p1__81051#)))
        layers)))
     (= {} (:opts d))))
   v14_l205)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__81052#]
       (.startsWith (.getName (class p1__81052#)) "membrane.ui."))
      (:drawables v))))
   v27_l263)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__81053#] (.startsWith p1__81053# "rgb"))
         (:colors s)))))))
   v42_l507)))
