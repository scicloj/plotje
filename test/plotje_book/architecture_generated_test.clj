    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__11193#] (= :petal-length (:x p1__11193#)))
        layers)
       (every?
        (fn* [p1__11194#] (= :petal-width (:y p1__11194#)))
        layers)
       (every?
        (fn* [p1__11195#] (= :species (:color p1__11195#)))
        layers)))
     (= {} (:opts d))))
   v14_l205)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__11196#]
       (.startsWith (.getName (class p1__11196#)) "membrane.ui."))
      (:drawables v))))
   v27_l263)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__11197#] (.startsWith p1__11197# "rgb"))
         (:colors s)))))))
   v42_l507)))
