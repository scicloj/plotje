    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__88597#] (= :petal-length (:x p1__88597#)))
        layers)
       (every?
        (fn* [p1__88598#] (= :petal-width (:y p1__88598#)))
        layers)
       (every?
        (fn* [p1__88599#] (= :species (:color p1__88599#)))
        layers)))
     (= {} (:opts d))))
   v14_l201)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__88600#]
       (.startsWith (.getName (class p1__88600#)) "membrane.ui."))
      (:drawables v))))
   v27_l259)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__88601#] (.startsWith p1__88601# "rgb"))
         (:colors s)))))))
   v42_l503)))
