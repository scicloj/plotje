    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__95110#] (= :petal-length (:x p1__95110#)))
        layers)
       (every?
        (fn* [p1__95111#] (= :petal-width (:y p1__95111#)))
        layers)
       (every?
        (fn* [p1__95112#] (= :species (:color p1__95112#)))
        layers)))
     (= {} (:opts d))))
   v14_l200)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__95113#]
       (.startsWith (.getName (class p1__95113#)) "membrane.ui."))
      (:drawables v))))
   v27_l258)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__95114#] (.startsWith p1__95114# "rgb"))
         (:colors s)))))))
   v40_l436)))
