    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__81134#] (= :petal-length (:x p1__81134#)))
        layers)
       (every?
        (fn* [p1__81135#] (= :petal-width (:y p1__81135#)))
        layers)
       (every?
        (fn* [p1__81136#] (= :species (:color p1__81136#)))
        layers)))
     (= {} (:opts d))))
   v14_l205)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__81137#]
       (.startsWith (.getName (class p1__81137#)) "membrane.ui."))
      (:drawables v))))
   v27_l263)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__81138#] (.startsWith p1__81138# "rgb"))
         (:colors s)))))))
   v42_l507)))
