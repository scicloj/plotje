    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__95836#] (= :petal-length (:x p1__95836#)))
        layers)
       (every?
        (fn* [p1__95837#] (= :petal-width (:y p1__95837#)))
        layers)
       (every?
        (fn* [p1__95838#] (= :species (:color p1__95838#)))
        layers)))
     (= {} (:opts d))))
   v14_l198)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__95839#]
       (.startsWith (.getName (class p1__95839#)) "membrane.ui."))
      (:drawables v))))
   v27_l256)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__95840#] (.startsWith p1__95840# "rgb"))
         (:colors s)))))))
   v40_l433)))
