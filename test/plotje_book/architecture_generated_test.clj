    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__85486#] (= :petal-length (:x p1__85486#)))
        layers)
       (every?
        (fn* [p1__85487#] (= :petal-width (:y p1__85487#)))
        layers)
       (every?
        (fn* [p1__85488#] (= :species (:color p1__85488#)))
        layers)))
     (= {} (:opts d))))
   v14_l201)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__85489#]
       (.startsWith (.getName (class p1__85489#)) "membrane.ui."))
      (:drawables v))))
   v27_l259)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__85490#] (.startsWith p1__85490# "rgb"))
         (:colors s)))))))
   v42_l503)))
