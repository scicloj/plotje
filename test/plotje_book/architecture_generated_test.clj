    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__97999#] (= :petal-length (:x p1__97999#)))
        layers)
       (every?
        (fn* [p1__98000#] (= :petal-width (:y p1__98000#)))
        layers)
       (every?
        (fn* [p1__98001#] (= :species (:color p1__98001#)))
        layers)))
     (= {} (:opts d))))
   v14_l198)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__98002#]
       (.startsWith (.getName (class p1__98002#)) "membrane.ui."))
      (:drawables v))))
   v27_l256)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__98003#] (.startsWith p1__98003# "rgb"))
         (:colors s)))))))
   v40_l434)))
