    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__92138#] (= :petal-length (:x p1__92138#)))
        layers)
       (every?
        (fn* [p1__92139#] (= :petal-width (:y p1__92139#)))
        layers)
       (every?
        (fn* [p1__92140#] (= :species (:color p1__92140#)))
        layers)))
     (= {} (:opts d))))
   v14_l205)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__92141#]
       (.startsWith (.getName (class p1__92141#)) "membrane.ui."))
      (:drawables v))))
   v27_l263)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__92142#] (.startsWith p1__92142# "rgb"))
         (:colors s)))))))
   v42_l507)))
