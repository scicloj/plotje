    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__88245#] (= :petal-length (:x p1__88245#)))
        layers)
       (every?
        (fn* [p1__88246#] (= :petal-width (:y p1__88246#)))
        layers)
       (every?
        (fn* [p1__88247#] (= :species (:color p1__88247#)))
        layers)))
     (= {} (:opts d))))
   v14_l198)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__88248#]
       (.startsWith (.getName (class p1__88248#)) "membrane.ui."))
      (:drawables v))))
   v27_l256)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__88249#] (.startsWith p1__88249# "rgb"))
         (:colors s)))))))
   v40_l434)))
