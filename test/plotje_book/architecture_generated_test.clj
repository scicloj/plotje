    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__81067#] (= :petal-length (:x p1__81067#)))
        layers)
       (every?
        (fn* [p1__81068#] (= :petal-width (:y p1__81068#)))
        layers)
       (every?
        (fn* [p1__81069#] (= :species (:color p1__81069#)))
        layers)))
     (= {} (:opts d))))
   v14_l205)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__81070#]
       (.startsWith (.getName (class p1__81070#)) "membrane.ui."))
      (:drawables v))))
   v27_l263)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__81071#] (.startsWith p1__81071# "rgb"))
         (:colors s)))))))
   v42_l507)))
