...
(def v17_l185 (-> my-pose pj/draft kind/pprint))
...
(def v20_l201 (-> my-pose pj/draft :layers first kind/pprint))
...
(deftest
 t36_l348
 (is ((fn [v] (pos? (:points (pj/svg-summary v)))) v35_l345)))


(def v38_l362 (def my-plan (pj/plan my-pose)))


(def v39_l364 (kind/pprint my-plan))
...
(def v42_l381 (kind/pprint (first (:panels my-plan))))
...
(def v45_l395 (kind/pprint (get-in my-plan [:panels 0 :layers 0])))
...
(def v54_l513 (-> my-plan :panels first :x-ticks))
...
(def v64_l626 annotated)


(def v65_l628 (kind/pprint (nth (:layers annotated) 1)))
...
(def v68_l645 (kind/pprint (:legend my-plan)))
...
(deftest
 t72_l675
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v71_l671)))


(def v74_l698 (def my-membrane (pj/plan->membrane my-plan)))


(def v76_l704 (kind/pprint my-membrane))
...
(def v79_l730 (def my-plot (pj/plan->plot my-plan :svg {})))


(def v81_l737 (kind/hiccup my-plot))
...
(deftest
 t85_l759
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v84_l755)))


(def v87_l765 (count (c2d/find-palette #".*")))


(deftest t88_l767 (is ((fn [n] (<= 5000 n)) v87_l765)))
...
(def v96_l828 (sort (keys pj/plot-option-docs)))
...
(def v99_l851 (sort (keys pj/layer-option-docs)))
