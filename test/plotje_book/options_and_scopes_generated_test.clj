...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__84825#] (dissoc p1__84825# :data))))
   (:poses pose)
...
(deftest
 t13_l157
 (is ((fn [v] (some #{"Iris"} (:texts (pj/svg-summary v)))) v12_l151)))
...
(def v18_l241 (select-keys (pj/config) [:width :height :margin]))
...
(def v26_l271 (pose-summary demo))
