...
(def
 ...
 (def
  ...
  (->
   ...
   (tc/select-rows (fn* [p1__95809#] (= 2007 (:year p1__95809#)))))))
    ...
    (=
     ...
     (->>
      ...
      (mapv
       (fn*
        [p1__95810#]
        (-> p1__95810# :plan :panels first :x-scale :type))))))
   v16_l141)))
...
(def
 v106_l671
 (->
  {:bin (map (fn* [p1__95811#] (str "bin-" p1__95811#)) (range 40)),
   :count (range 40)}
 ...
 (is
  ((fn
    ...
    (let
     [labels
      (filter
       (fn* [p1__95812#] (.startsWith p1__95812# "bin-"))
      ...
      (mapv
       ...
       (->
        (update
         squares
         :n
         (fn [ns] (mapv (fn* [p1__95813#] (* 100 p1__95813#)) ns)))
        (pj/lay-point :step :row {:size :n})
        pj/plan
        :size-legend
        :entries)))))
...
(def
 ...
 (->
  {:step (range 40),
   ...
   :n
   (map
    (fn* [p1__95814#] (Math/pow 10 (/ p1__95814# 10.0)))
    (range 40))}
