...
(def
 ...
 (def
  ...
  (->
   ...
   (tc/select-rows (fn* [p1__88625#] (= 2007 (:year p1__88625#)))))))
    ...
    (=
     ...
     (->>
      ...
      (mapv
       (fn*
        [p1__88626#]
        (-> p1__88626# :plan :panels first :x-scale :type))))))
   v16_l141)))
...
(def
 v106_l671
 (->
  {:bin (map (fn* [p1__88627#] (str "bin-" p1__88627#)) (range 40)),
   :count (range 40)}
 ...
 (is
  ((fn
    ...
    (let
     [labels
      (filter
       (fn* [p1__88628#] (.startsWith p1__88628# "bin-"))
      ...
      (mapv
       ...
       (->
        (update
         squares
         :n
         (fn [ns] (mapv (fn* [p1__88629#] (* 100 p1__88629#)) ns)))
        (pj/lay-point :step :row {:size :n})
        pj/plan
        :size-legend
        :entries)))))
...
(def
 ...
 (->
  {:step (range 40),
   ...
   :n
   (map
    (fn* [p1__88630#] (Math/pow 10 (/ p1__88630# 10.0)))
    (range 40))}
