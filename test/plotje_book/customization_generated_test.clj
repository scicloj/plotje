...
(def
 ...
 (->
  {:product
   (map (fn* [p1__71936#] (str "Product " p1__71936#)) (range 12)),
...
(def
 ...
 (->
  {:product
   (map (fn* [p1__71937#] (str "Product " p1__71937#)) (range 12)),
   :revenue [120 95 140 60 175 80 110 150 90 130 70 160]}
  (pj/lay-bar :product :revenue)
...
(def
 ...
 (->>
  (->
   ...
   pj/svg-summary
   :texts)
  (filter (fn* [p1__71938#] (re-find #"," p1__71938#)))
  distinct
  sort))
     ...
     (and
      ...
      (=
       ...
       (->>
        ...
        first
        :layers
        (filter (fn* [p1__71939#] (= :text (:mark p1__71939#))))
        (mapv
         (fn*
          [p1__71940#]
          (-> p1__71940# :style :box :corner-radius))))))))
   v98_l526)))
...
(deftest
 t117_l648
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v116_l644)))
...
(deftest
 t120_l656
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v119_l652)))


(def v122_l668 (c2d/find-palette #"budapest"))
...
(def v125_l674 (c2d/find-palette #"^:set"))


(deftest
 t126_l676
 (is ((fn [v] (and (sequential? v) (some #{:set1} v))) v125_l674)))


(def v128_l680 (c2d/find-gradient #"viridis"))
...
(def v131_l687 (c2d/palette :grand-budapest-1))


(deftest
 t132_l689
 (is ((fn [v] (and (sequential? v) (pos? (count v)))) v131_l687)))
...
(deftest
 t135_l705
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v134_l701)))
...
(deftest
 t144_l738
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v143_l734)))
