  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__75068#] (= "Distribution of Total Bill" p1__75068#))
       (:texts s)))))
   v12_l53)))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (fn*
       [p1__75069#]
       (-> p1__75069# pj/plan :panels first :x-domain))]
     (and
      (= 1 (:panels s))
      (= 10 (:polygons s))
      (= [4.12 8.08] (domain v))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (fn*
       [p1__75070#]
       (-> p1__75070# pj/plan :panels first :x-domain))]
     (and
      (= 1 (:panels s))
      (= 1 (:polygons s))
      (= 150 (:lines s))
    ...
    (let
     [s
      ...
      (->>
       ...
       first
       :layers
       (filter (fn* [p1__75071#] (= :boxplot (:mark p1__75071#))))
       first
       :boxes)
      within-fences?
      (fn
  ...
  ((fn
    ...
    (let
     [s
      ...
      (first
       (filter
        (fn* [p1__75072#] (= :boxplot (:mark p1__75072#)))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (first
       (filter
        (fn* [p1__75073#] (= :violin (:mark p1__75073#)))
        (:layers (first (:panels plan)))))]
     (and
      (= 1 (:panels s))
      (= 8 (:polygons s))
