  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__72628#] (= "Distribution of Total Bill" p1__72628#))
       (:texts s)))))
   v12_l53)))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (fn*
       [p1__72629#]
       (-> p1__72629# pj/plan :panels first :x-domain))]
     (and
      (= 1 (:panels s))
      (= 10 (:polygons s))
      (= [4.12 8.08] (domain v))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (fn*
       [p1__72630#]
       (-> p1__72630# pj/plan :panels first :x-domain))]
     (and
      (= 1 (:panels s))
      (= 1 (:polygons s))
      (= 150 (:lines s))
    ...
    (let
     [s
      ...
      (->>
       ...
       first
       :layers
       (filter (fn* [p1__72631#] (= :boxplot (:mark p1__72631#))))
       first
       :boxes)
      within-fences?
      (fn
  ...
  ((fn
    ...
    (let
     [s
      ...
      (first
       (filter
        (fn* [p1__72632#] (= :boxplot (:mark p1__72632#)))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (first
       (filter
        (fn* [p1__72633#] (= :violin (:mark p1__72633#)))
        (:layers (first (:panels plan)))))]
     (and
      (= 1 (:panels s))
      (= 8 (:polygons s))
