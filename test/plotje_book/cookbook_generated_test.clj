 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__75900#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__75900#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__75901#] (= "virginica" p1__75901#))
       (:texts s)))))
   v67_l314)))
    ...
    (let
     [text-layer
      (->>
       ...
       first
       :layers
       (filter (fn* [p1__75902#] (= :text (:mark p1__75902#))))
       first)]
  ...
  ((fn
    ...
    (=
     ...
     (->>
      ...
      first
      :layers
      (filter (fn* [p1__75903#] (= :text (:mark p1__75903#))))
      first
      :groups
      first
      :labels)))
    ...
    (let
     [layers
      ...
      (fn
       ...
       (->>
        layers
        (filter (fn* [p1__75904#] (= mark (:mark p1__75904#))))
        first
        :groups
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__75905#] (Math/sin (/ p1__75905# 3.0))) (range 20)),
   :change (map (fn* [p1__75906#] (- p1__75906# 10)) (range 20))}
 ...
 (->
  ...
  (pj/lay-text
   {:data
    (tc/select-rows
     life-tracks
     (fn* [p1__75908#] (= 2007 (:year p1__75908#)))),
    :x :year,
    :y :life-exp,
    :text :country,
    :color :country,
...
(def
 ...
 (->
  (rdatasets/gapminder-gapminder)
  (tc/select-rows
   (fn* [p1__75909#] (= "Rwanda" (:country p1__75909#))))
...
(def
 ...
 (def
  ...
  (->
   life-history
   (tc/select-rows (fn* [p1__75910#] (= 2007 (:year p1__75910#))))
...
(def
 ...
 (let
  [named
   ...
   (tc/select-rows
    life-history
    (fn* [p1__75911#] (named (:country p1__75911#))))]
  (->
   life-history
   ...
   (pj/lay-text
    {:data
     (tc/select-rows
      chosen
      (fn* [p1__75912#] (= 2007 (:year p1__75912#)))),
     :x :year,
     :y :life-exp,
     :text :country,
     :color :country,
    ...
    (let
     ...
     (and
      ...
      (some
       (fn*
        [p1__75913#]
        (re-find #"^Rwanda, 1992: a fall of 20 years" p1__75913#))
       (:texts s))
      (some
       (fn* [p1__75914#] (= "142 countries, 1952-2007" p1__75914#))
       (:texts s)))))
   v122_l671)))
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__75915#]
     (+ (* 3 p1__75915#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__75916#] (bit-and p1__75916# 255)) (vec bs))))))
