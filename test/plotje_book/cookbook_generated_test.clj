 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__72525#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__72525#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__72526#] (= "virginica" p1__72526#))
       (:texts s)))))
   v67_l314)))
    ...
    (let
     [text-layer
      (->>
       ...
       first
       :layers
       (filter (fn* [p1__72527#] (= :text (:mark p1__72527#))))
       first)]
  ...
  ((fn
    ...
    (=
     ...
     (->>
      ...
      first
      :layers
      (filter (fn* [p1__72528#] (= :text (:mark p1__72528#))))
      first
      :groups
      first
      :labels)))
    ...
    (let
     [layers
      ...
      (fn
       ...
       (->>
        layers
        (filter (fn* [p1__72529#] (= mark (:mark p1__72529#))))
        first
        :groups
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__72530#] (Math/sin (/ p1__72530# 3.0))) (range 20)),
   :change (map (fn* [p1__72531#] (- p1__72531# 10)) (range 20))}
 ...
 (->
  ...
  (pj/lay-text
   {:data
    (tc/select-rows
     life-tracks
     (fn* [p1__72533#] (= 2007 (:year p1__72533#)))),
    :x :year,
    :y :life-exp,
    :text :country,
    :color :country,
...
(def
 ...
 (->
  (rdatasets/gapminder-gapminder)
  (tc/select-rows
   (fn* [p1__72534#] (= "Rwanda" (:country p1__72534#))))
...
(def
 ...
 (def
  ...
  (->
   life-history
   (tc/select-rows (fn* [p1__72535#] (= 2007 (:year p1__72535#))))
...
(def
 ...
 (let
  [named
   ...
   (tc/select-rows
    life-history
    (fn* [p1__72536#] (named (:country p1__72536#))))]
  (->
   life-history
   ...
   (pj/lay-text
    {:data
     (tc/select-rows
      chosen
      (fn* [p1__72537#] (= 2007 (:year p1__72537#)))),
     :x :year,
     :y :life-exp,
     :text :country,
     :color :country,
    ...
    (let
     ...
     (and
      ...
      (some
       (fn*
        [p1__72538#]
        (re-find #"^Rwanda, 1992: a fall of 20 years" p1__72538#))
       (:texts s))
      (some
       (fn* [p1__72539#] (= "142 countries, 1952-2007" p1__72539#))
       (:texts s)))))
   v122_l671)))
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__72540#]
     (+ (* 3 p1__72540#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__72541#] (bit-and p1__72541# 255)) (vec bs))))))
