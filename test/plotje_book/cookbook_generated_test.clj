 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__92819#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__92819#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__92820#] (= "virginica" p1__92820#))
       (:texts s)))))
   v70_l328)))
    ...
    (let
     [text-layer
      (->>
       ...
       first
       :layers
       (filter (fn* [p1__92821#] (= :text (:mark p1__92821#))))
       first)]
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__92822#] (Math/sin (/ p1__92822# 3.0))) (range 20)),
   :change (map (fn* [p1__92823#] (- p1__92823# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__92824#]
     (+ (* 3 p1__92824#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
...
(deftest
 t141_l652
 (is ((fn [v] (= 500 (:points (pj/svg-summary v)))) v140_l647)))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__92825#] (bit-and p1__92825# 255)) (vec bs))))))


(deftest
 t147_l681
 (is ((fn [bs] (= [137 80 78 71 13 10 26 10] bs)) v146_l671)))
