...
(def
 ...
 (def
  ...
  (tc/select-rows
   (rdatasets/datasets-iris)
   (fn* [p1__82014#] (= "setosa" (:species p1__82014#))))))
...
(def
 ...
 (def
  ...
  (tc/select-rows
   (rdatasets/datasets-iris)
   (fn* [p1__82015#] (= "versicolor" (:species p1__82015#))))))
...
(deftest
 t140_l700
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v139_l695)))
...
(deftest
 t158_l786
 (is ((fn [v] (= :species (get-in v [:opts :facet-col]))) v157_l779)))
...
(deftest
 t161_l793
 (is ((fn [v] (= 3 (:panels (pj/svg-summary v)))) v160_l790)))
...
(deftest
 t167_l816
 (is ((fn [v] (= 2 (:panels (pj/svg-summary v)))) v166_l810)))
