...
(def
 ...
 (def
  ...
  (tc/select-rows
   (rdatasets/datasets-iris)
   (fn* [p1__105745#] (= "setosa" (:species p1__105745#))))))
...
(def
 ...
 (def
  ...
  (tc/select-rows
   (rdatasets/datasets-iris)
   (fn* [p1__105746#] (= "versicolor" (:species p1__105746#))))))
...
(deftest
 t61_l344
 (is ((fn [v] (= 2 (:panels (pj/svg-summary v)))) v60_l340)))
...
(deftest
 t67_l367
 (is ((fn [v] (= 2 (:panels (pj/svg-summary v)))) v66_l363)))


(def v69_l399 (pj/layer-type-lookup :histogram))


(deftest t70_l401 (is ((fn [m] (= :bar (:mark m))) v69_l399)))
...
(deftest
 t73_l408
 (is ((fn [v] (pos? (:polygons (pj/svg-summary v)))) v72_l405)))


(def v75_l412 (pj/layer-type-lookup :smooth))


(deftest t76_l414 (is ((fn [m] (= :loess (:stat m))) v75_l412)))
...
(deftest
 t79_l423
 (is ((fn [v] (pos? (:polygons (pj/svg-summary v)))) v78_l418)))
...
(deftest
 t113_l581
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v112_l578)))
...
(deftest
 t125_l628
 (is ((fn [v] (pos? (:polygons (pj/svg-summary v)))) v124_l625)))
...
(deftest
 t128_l641
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v127_l637)))
...
(deftest
 t140_l702
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v139_l697)))
...
(deftest
 t146_l734
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v145_l730)))
...
(deftest
 t152_l760
 (is ((fn [v] (= 6 (:points (pj/svg-summary v)))) v151_l754)))
...
(deftest
 t158_l788
 (is ((fn [v] (= :species (get-in v [:opts :facet-col]))) v157_l781)))
...
(deftest
 t161_l795
 (is ((fn [v] (= 3 (:panels (pj/svg-summary v)))) v160_l792)))
...
(deftest
 t167_l818
 (is ((fn [v] (= 2 (:panels (pj/svg-summary v)))) v166_l812)))
