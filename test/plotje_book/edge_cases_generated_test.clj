...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__89216#] (keyword (str "cat-" p1__89216#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__89217#] (= "setosa" (p1__89217# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__89218#] (- p1__89218# 10)) (range 20)),
   :val (map (fn* [p1__89219#] (- p1__89219# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__89220#] (* (long p1__89220#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__89221#] (+ 18.0 (* 4.0 (Math/sin (* p1__89221# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__89222#] (+ 20.0 (* 5.0 (Math/sin (* p1__89222# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__89223#] (re-find #":\d\d" p1__89223#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__89224#] (* (long p1__89224#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__89225#] (+ 100 (* 50 (Math/sin (* p1__89225# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__89226#] (str "cat-" p1__89226#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__89227#] (re-find #"sepal|petal" p1__89227#))]
