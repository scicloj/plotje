...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__82155#] (keyword (str "cat-" p1__82155#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__82156#] (= "setosa" (p1__82156# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__82157#] (- p1__82157# 10)) (range 20)),
   :val (map (fn* [p1__82158#] (- p1__82158# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__82159#] (* (long p1__82159#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__82160#] (+ 18.0 (* 4.0 (Math/sin (* p1__82160# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__82161#] (+ 20.0 (* 5.0 (Math/sin (* p1__82161# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__82162#] (re-find #":\d\d" p1__82162#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__82163#] (* (long p1__82163#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__82164#] (+ 100 (* 50 (Math/sin (* p1__82164# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__82165#] (str "cat-" p1__82165#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__82166#] (re-find #"sepal|petal" p1__82166#))]
