...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__93237#] (keyword (str "cat-" p1__93237#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__93238#] (= "setosa" (p1__93238# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__93239#] (- p1__93239# 10)) (range 20)),
   :val (map (fn* [p1__93240#] (- p1__93240# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__93241#] (* (long p1__93241#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__93242#] (+ 18.0 (* 4.0 (Math/sin (* p1__93242# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__93243#] (+ 20.0 (* 5.0 (Math/sin (* p1__93243# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__93244#] (re-find #":\d\d" p1__93244#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__93245#] (* (long p1__93245#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__93246#] (+ 100 (* 50 (Math/sin (* p1__93246# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__93247#] (str "cat-" p1__93247#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__93248#] (re-find #"sepal|petal" p1__93248#))]
