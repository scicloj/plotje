...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__92768#] (keyword (str "cat-" p1__92768#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__92769#] (= "setosa" (p1__92769# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__92770#] (- p1__92770# 10)) (range 20)),
   :val (map (fn* [p1__92771#] (- p1__92771# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__92772#] (* (long p1__92772#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__92773#] (+ 18.0 (* 4.0 (Math/sin (* p1__92773# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__92774#] (+ 20.0 (* 5.0 (Math/sin (* p1__92774# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__92775#] (re-find #":\d\d" p1__92775#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__92776#] (* (long p1__92776#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__92777#] (+ 100 (* 50 (Math/sin (* p1__92777# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__92778#] (str "cat-" p1__92778#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__92779#] (re-find #"sepal|petal" p1__92779#))]
