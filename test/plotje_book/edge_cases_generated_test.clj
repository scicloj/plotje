...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__77973#] (keyword (str "cat-" p1__77973#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__77974#] (= "setosa" (p1__77974# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__77975#] (- p1__77975# 10)) (range 20)),
   :val (map (fn* [p1__77976#] (- p1__77976# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__77977#] (* (long p1__77977#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__77978#] (+ 18.0 (* 4.0 (Math/sin (* p1__77978# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__77979#] (+ 20.0 (* 5.0 (Math/sin (* p1__77979# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__77980#] (re-find #":\d\d" p1__77980#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__77981#] (* (long p1__77981#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__77982#] (+ 100 (* 50 (Math/sin (* p1__77982# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__77983#] (str "cat-" p1__77983#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__77984#] (re-find #"sepal|petal" p1__77984#))]
