...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__91804#] (keyword (str "cat-" p1__91804#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__91805#] (= "setosa" (p1__91805# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__91806#] (- p1__91806# 10)) (range 20)),
   :val (map (fn* [p1__91807#] (- p1__91807# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__91808#] (* (long p1__91808#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__91809#] (+ 18.0 (* 4.0 (Math/sin (* p1__91809# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__91810#] (+ 20.0 (* 5.0 (Math/sin (* p1__91810# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__91811#] (re-find #":\d\d" p1__91811#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__91812#] (* (long p1__91812#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__91813#] (+ 100 (* 50 (Math/sin (* p1__91813# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__91814#] (str "cat-" p1__91814#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__91815#] (re-find #"sepal|petal" p1__91815#))]
