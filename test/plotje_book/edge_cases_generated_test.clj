...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__97047#] (keyword (str "cat-" p1__97047#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__97048#] (= "setosa" (p1__97048# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__97049#] (- p1__97049# 10)) (range 20)),
   :val (map (fn* [p1__97050#] (- p1__97050# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__97051#] (* (long p1__97051#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__97052#] (+ 18.0 (* 4.0 (Math/sin (* p1__97052# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__97053#] (+ 20.0 (* 5.0 (Math/sin (* p1__97053# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__97054#] (re-find #":\d\d" p1__97054#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__97055#] (* (long p1__97055#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__97056#] (+ 100 (* 50 (Math/sin (* p1__97056# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__97057#] (str "cat-" p1__97057#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__97058#] (re-find #"sepal|petal" p1__97058#))]
