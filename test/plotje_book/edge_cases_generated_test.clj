...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__78802#] (keyword (str "cat-" p1__78802#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__78803#] (= "setosa" (p1__78803# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__78804#] (- p1__78804# 10)) (range 20)),
   :val (map (fn* [p1__78805#] (- p1__78805# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__78806#] (* (long p1__78806#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__78807#] (+ 18.0 (* 4.0 (Math/sin (* p1__78807# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__78808#] (+ 20.0 (* 5.0 (Math/sin (* p1__78808# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__78809#] (re-find #":\d\d" p1__78809#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__78810#] (* (long p1__78810#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__78811#] (+ 100 (* 50 (Math/sin (* p1__78811# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__78812#] (str "cat-" p1__78812#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__78813#] (re-find #"sepal|petal" p1__78813#))]
