...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__78471#] (keyword (str "cat-" p1__78471#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__78472#] (= "setosa" (p1__78472# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__78473#] (- p1__78473# 10)) (range 20)),
   :val (map (fn* [p1__78474#] (- p1__78474# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__78475#] (* (long p1__78475#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__78476#] (+ 18.0 (* 4.0 (Math/sin (* p1__78476# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__78477#] (+ 20.0 (* 5.0 (Math/sin (* p1__78477# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__78478#] (re-find #":\d\d" p1__78478#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__78479#] (* (long p1__78479#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__78480#] (+ 100 (* 50 (Math/sin (* p1__78480# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__78481#] (str "cat-" p1__78481#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__78482#] (re-find #"sepal|petal" p1__78482#))]
