...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__86573#] (keyword (str "cat-" p1__86573#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__86574#] (= "setosa" (p1__86574# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__86575#] (- p1__86575# 10)) (range 20)),
   :val (map (fn* [p1__86576#] (- p1__86576# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86577#] (* (long p1__86577#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__86578#] (+ 18.0 (* 4.0 (Math/sin (* p1__86578# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__86579#] (+ 20.0 (* 5.0 (Math/sin (* p1__86579# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__86580#] (re-find #":\d\d" p1__86580#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86581#] (* (long p1__86581#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__86582#] (+ 100 (* 50 (Math/sin (* p1__86582# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__86583#] (str "cat-" p1__86583#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__86584#] (re-find #"sepal|petal" p1__86584#))]
