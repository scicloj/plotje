...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__100421#] (keyword (str "cat-" p1__100421#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__100422#] (= "setosa" (p1__100422# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__100423#] (- p1__100423# 10)) (range 20)),
   :val (map (fn* [p1__100424#] (- p1__100424# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__100425#] (* (long p1__100425#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__100426#] (+ 18.0 (* 4.0 (Math/sin (* p1__100426# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__100427#] (+ 20.0 (* 5.0 (Math/sin (* p1__100427# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__100428#] (re-find #":\d\d" p1__100428#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__100429#] (* (long p1__100429#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__100430#] (+ 100 (* 50 (Math/sin (* p1__100430# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__100431#] (str "cat-" p1__100431#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__100432#] (re-find #"sepal|petal" p1__100432#))]
