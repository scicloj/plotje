...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__73505#] (dissoc p1__73505# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__73506#] (= 2 (count (:poses p1__73506#))))
      (:poses pose))))
   v76_l415)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__73507#]
        (when (= :rule-h (:layer-type p1__73507#)) p1__73507#))
       layers)]
     ...
     [x-domains
      (fn
       ...
       (mapv
        (fn*
         [p1__73508#]
         (get-in p1__73508# [:plan :panels 0 :x-domain]))
        (:sub-plots (pj/plan p))))
      domains
      (x-domains pose)
      cells
      (fn
       ...
       (pj/arrange
        [(->
          iris
          (tc/select-rows
           (fn* [p1__73509#] (= "setosa" (:species p1__73509#))))
          (pj/pose :sepal-length :sepal-width)
          pj/lay-point)
         (->
          iris
          (tc/select-rows
           (fn* [p1__73510#] (= "virginica" (:species p1__73510#))))
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__73511#] (= 2 (count (:poses p1__73511#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))
     (=
      [[{:x :sepal-length, :y :petal-length}
