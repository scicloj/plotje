...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__96302#] (dissoc p1__96302# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__96303#] (= 2 (count (:poses p1__96303#))))
      (:poses pose))))
   v76_l413)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__96304#]
        (when (= :rule-h (:layer-type p1__96304#)) p1__96304#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__96305#]
        (get-in p1__96305# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__96306#] (= 2 (count (:poses p1__96306#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v184_l1130)))
