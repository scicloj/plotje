...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__82449#] (dissoc p1__82449# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__82450#] (= 2 (count (:poses p1__82450#))))
      (:poses pose))))
   v76_l411)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__82451#]
        (when (= :rule-h (:layer-type p1__82451#)) p1__82451#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__82452#]
        (get-in p1__82452# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__82453#] (= 2 (count (:poses p1__82453#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v184_l1128)))
