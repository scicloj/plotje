...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__90744#] (dissoc p1__90744# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__90745#] (= 2 (count (:poses p1__90745#))))
      (:poses pose))))
   v76_l411)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__90746#]
        (when (= :rule-h (:layer-type p1__90746#)) p1__90746#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__90747#]
        (get-in p1__90747# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__90748#] (= 2 (count (:poses p1__90748#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v184_l1128)))
