...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__78072#] (dissoc p1__78072# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__78073#] (= 2 (count (:poses p1__78073#))))
      (:poses pose))))
   v76_l415)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__78074#]
        (when (= :rule-h (:layer-type p1__78074#)) p1__78074#))
       layers)]
     ...
     [x-domains
      (fn
       ...
       (mapv
        (fn*
         [p1__78075#]
         (get-in p1__78075# [:plan :panels 0 :x-domain]))
        (:sub-plots (pj/plan p))))
      domains
      (x-domains pose)
      cells
      (fn
       ...
       (pj/arrange
        [(->
          iris
          (tc/select-rows
           (fn* [p1__78076#] (= "setosa" (:species p1__78076#))))
          (pj/pose :sepal-length :sepal-width)
          pj/lay-point)
         (->
          iris
          (tc/select-rows
           (fn* [p1__78077#] (= "virginica" (:species p1__78077#))))
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__78078#] (= 2 (count (:poses p1__78078#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))
     (=
      [[{:x :sepal-length, :y :petal-length}
