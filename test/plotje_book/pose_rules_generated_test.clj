...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__84901#] (dissoc p1__84901# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__84902#] (= 2 (count (:poses p1__84902#))))
      (:poses pose))))
   v76_l413)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__84903#]
        (when (= :rule-h (:layer-type p1__84903#)) p1__84903#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__84904#]
        (get-in p1__84904# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__84905#] (= 2 (count (:poses p1__84905#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v184_l1130)))
