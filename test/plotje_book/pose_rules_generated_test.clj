...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__82489#] (dissoc p1__82489# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__82490#] (= 2 (count (:poses p1__82490#))))
      (:poses pose))))
   v76_l411)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__82491#]
        (when (= :rule-h (:layer-type p1__82491#)) p1__82491#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__82492#]
        (get-in p1__82492# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__82493#] (= 2 (count (:poses p1__82493#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v184_l1128)))
