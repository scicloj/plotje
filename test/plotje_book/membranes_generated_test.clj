...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__102725#] (instance? membrane.ui.ScissorView p1__102725#)))
  (mapv
   (fn* [p1__102726#] (select-keys p1__102726# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__102727#] (= [0 0] (:offset p1__102727#))) rects)
     (some
      (fn* [p1__102728#] (every? pos? (:offset p1__102728#)))
      rects)))
   v51_l300)))
