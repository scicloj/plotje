...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__77935#] (instance? membrane.ui.ScissorView p1__77935#)))
  (mapv (fn* [p1__77936#] (select-keys p1__77936# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__77937#] (= [0 0] (:offset p1__77937#))) rects)
     (some
      (fn* [p1__77938#] (every? pos? (:offset p1__77938#)))
      rects)))
   v51_l300)))
