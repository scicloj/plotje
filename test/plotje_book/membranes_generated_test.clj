...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__78773#] (instance? membrane.ui.ScissorView p1__78773#)))
  (mapv (fn* [p1__78774#] (select-keys p1__78774# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__78775#] (= [0 0] (:offset p1__78775#))) rects)
     (some
      (fn* [p1__78776#] (every? pos? (:offset p1__78776#)))
      rects)))
   v51_l300)))
