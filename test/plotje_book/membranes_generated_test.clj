...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__86037#] (instance? membrane.ui.ScissorView p1__86037#)))
  (mapv (fn* [p1__86038#] (select-keys p1__86038# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__86039#] (= [0 0] (:offset p1__86039#))) rects)
     (some
      (fn* [p1__86040#] (every? pos? (:offset p1__86040#)))
      rects)))
   v51_l300)))
