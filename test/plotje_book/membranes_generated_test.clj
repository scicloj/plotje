...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__96722#] (instance? membrane.ui.ScissorView p1__96722#)))
  (mapv (fn* [p1__96723#] (select-keys p1__96723# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__96724#] (= [0 0] (:offset p1__96724#))) rects)
     (some
      (fn* [p1__96725#] (every? pos? (:offset p1__96725#)))
      rects)))
   v51_l300)))
