...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__91380#] (instance? membrane.ui.ScissorView p1__91380#)))
  (mapv (fn* [p1__91381#] (select-keys p1__91381# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__91382#] (= [0 0] (:offset p1__91382#))) rects)
     (some
      (fn* [p1__91383#] (every? pos? (:offset p1__91383#)))
      rects)))
   v51_l300)))
