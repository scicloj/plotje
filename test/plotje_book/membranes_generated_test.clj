...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__90321#] (instance? membrane.ui.ScissorView p1__90321#)))
  (mapv (fn* [p1__90322#] (select-keys p1__90322# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__90323#] (= [0 0] (:offset p1__90323#))) rects)
     (some
      (fn* [p1__90324#] (every? pos? (:offset p1__90324#)))
      rects)))
   v51_l300)))
