...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__89044#] (instance? membrane.ui.ScissorView p1__89044#)))
  (mapv (fn* [p1__89045#] (select-keys p1__89045# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__89046#] (= [0 0] (:offset p1__89046#))) rects)
     (some
      (fn* [p1__89047#] (every? pos? (:offset p1__89047#)))
      rects)))
   v51_l300)))
