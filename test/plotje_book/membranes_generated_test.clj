...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__77549#] (instance? membrane.ui.ScissorView p1__77549#)))
  (mapv (fn* [p1__77550#] (select-keys p1__77550# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__77551#] (= [0 0] (:offset p1__77551#))) rects)
     (some
      (fn* [p1__77552#] (every? pos? (:offset p1__77552#)))
      rects)))
   v51_l300)))
