...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__81607#] (instance? membrane.ui.ScissorView p1__81607#)))
  (mapv (fn* [p1__81608#] (select-keys p1__81608# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__81609#] (= [0 0] (:offset p1__81609#))) rects)
     (some
      (fn* [p1__81610#] (every? pos? (:offset p1__81610#)))
      rects)))
   v51_l300)))
