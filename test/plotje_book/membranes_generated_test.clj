...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__96623#] (instance? membrane.ui.ScissorView p1__96623#)))
  (mapv (fn* [p1__96624#] (select-keys p1__96624# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__96625#] (= [0 0] (:offset p1__96625#))) rects)
     (some
      (fn* [p1__96626#] (every? pos? (:offset p1__96626#)))
      rects)))
   v51_l300)))
