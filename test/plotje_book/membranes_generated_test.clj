...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__88822#] (instance? membrane.ui.ScissorView p1__88822#)))
  (mapv (fn* [p1__88823#] (select-keys p1__88823# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__88824#] (= [0 0] (:offset p1__88824#))) rects)
     (some
      (fn* [p1__88825#] (every? pos? (:offset p1__88825#)))
      rects)))
   v45_l275)))
