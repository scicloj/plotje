...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__92689#] (instance? membrane.ui.ScissorView p1__92689#)))
  (mapv (fn* [p1__92690#] (select-keys p1__92690# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__92691#] (= [0 0] (:offset p1__92691#))) rects)
     (some
      (fn* [p1__92692#] (every? pos? (:offset p1__92692#)))
      rects)))
   v51_l300)))
