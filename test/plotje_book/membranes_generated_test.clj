...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__88782#] (instance? membrane.ui.ScissorView p1__88782#)))
  (mapv (fn* [p1__88783#] (select-keys p1__88783# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__88784#] (= [0 0] (:offset p1__88784#))) rects)
     (some
      (fn* [p1__88785#] (every? pos? (:offset p1__88785#)))
      rects)))
   v45_l275)))
