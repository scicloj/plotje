...
(def
 ...
 (->>
  ...
  (tree-seq coll? seq)
  (filter
   (fn* [p1__99873#] (instance? membrane.ui.ScissorView p1__99873#)))
  (mapv (fn* [p1__99874#] (select-keys p1__99874# [:offset :bounds])))))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 2 (count rects))
     (some (fn* [p1__99875#] (= [0 0] (:offset p1__99875#))) rects)
     (some
      (fn* [p1__99876#] (every? pos? (:offset p1__99876#)))
      rects)))
   v51_l300)))
