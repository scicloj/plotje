  ...
  ((fn
    ...
    (=
     ...
     (->>
      ...
      first
      :layers
      (filter (fn* [p1__96716#] (= :text (:mark p1__96716#))))
      (mapv (fn* [p1__96717#] (-> p1__96717# :style :align-x))))))
   v3_l79)))
    ...
    (let
     [style-of
      (->>
       ...
       first
       :layers
       (filter (fn* [p1__96718#] (= :text (:mark p1__96718#))))
       first
       :style)
      text-style
      (fn
       ...
       (->>
        ...
        first
        :layers
        (filter (fn* [p1__96719#] (= :text (:mark p1__96719#))))
        first
        :style
        ((fn*
          [p1__96720#]
          (select-keys p1__96720# [:align-x :align-y])))))]
     (and
  ...
  ((fn
    ...
    (let
     [panel
      ...
      at
      (fn* [p1__96721#] (first (pj/to-drawing panel p1__96721# 20.0)))]
  ...
  ((fn
    ...
    (let
     [panel
      (-> fr pj/frames :panels first)
      at
      (fn* [p1__96722#] (first (pj/to-drawing panel p1__96722# 20.0)))]
     (and
      (=
       [79.0 460.0]
...
(def
 ...
 (let
  [base
   ...
   (fn*
    [p1__96723#]
    (:x-domain (first (:panels (pj/plan p1__96723#)))))]
  ...
  ((fn
    ...
    (every?
     ...
     (map
      (fn*
       [p1__96724# p2__96725#]
       (< (abs (- p1__96724# p2__96725#)) 1.0E-9))
      (:round-trip m)
      [2.62 21.0])))
   v42_l367)))
   ...
   (fn
    ...
    (let
     [panel
      ...
      at
      (fn* [p1__96726#] (first (pj/to-drawing panel p1__96726# 20.0)))]
     (- (at (+ lo 0.08)) (at lo))))]
...
(def
 ...
 (let
  [drawing-area
   (fn*
    [p1__96727#]
    (-> p1__96727# pj/frames :panels first :frames :drawing-area))]
  ...
  ((fn
    ...
    (let
     [drawing-area
      (fn*
       [p1__96728#]
       (-> p1__96728# pj/frames :panels first :frames :drawing-area))]
     (and
      (= 6 (tc/row-count cars))
