  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__82020#] (nth waterfall-bars p1__82020#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__82021#] (nth waterfall-bars p1__82021#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__82022#] (= green (:color p1__82022#)))
       positive-bars)
      (every?
       (fn* [p1__82023#] (= red (:color p1__82023#)))
       negative-bars))))
   v17_l164)))
