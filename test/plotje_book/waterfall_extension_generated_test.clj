  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__83601#] (nth waterfall-bars p1__83601#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__83602#] (nth waterfall-bars p1__83602#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__83603#] (= green (:color p1__83603#)))
       positive-bars)
      (every?
       (fn* [p1__83604#] (= red (:color p1__83604#)))
       negative-bars))))
   v17_l164)))
