  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__92633#] (nth waterfall-bars p1__92633#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__92634#] (nth waterfall-bars p1__92634#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__92635#] (= green (:color p1__92635#)))
       positive-bars)
      (every?
       (fn* [p1__92636#] (= red (:color p1__92636#)))
       negative-bars))))
   v17_l164)))
