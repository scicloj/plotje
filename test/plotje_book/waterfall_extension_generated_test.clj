  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__86438#] (nth waterfall-bars p1__86438#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__86439#] (nth waterfall-bars p1__86439#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__86440#] (= green (:color p1__86440#)))
       positive-bars)
      (every?
       (fn* [p1__86441#] (= red (:color p1__86441#)))
       negative-bars))))
   v17_l164)))
