  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__78667#] (nth waterfall-bars p1__78667#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__78668#] (nth waterfall-bars p1__78668#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__78669#] (= green (:color p1__78669#)))
       positive-bars)
      (every?
       (fn* [p1__78670#] (= red (:color p1__78670#)))
       negative-bars))))
   v17_l164)))
