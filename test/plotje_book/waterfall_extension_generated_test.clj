  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__79180#] (nth waterfall-bars p1__79180#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__79181#] (nth waterfall-bars p1__79181#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__79182#] (= green (:color p1__79182#)))
       positive-bars)
      (every?
       (fn* [p1__79183#] (= red (:color p1__79183#)))
       negative-bars))))
   v17_l164)))
