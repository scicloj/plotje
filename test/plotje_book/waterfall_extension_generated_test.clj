  ...
  ((fn
    ...
    (let
     [s
      ...
      positive-bars
      (mapv
       (fn* [p1__100286#] (nth waterfall-bars p1__100286#))
       [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__100287#] (nth waterfall-bars p1__100287#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__100288#] (= green (:color p1__100288#)))
       positive-bars)
      (every?
       (fn* [p1__100289#] (= red (:color p1__100289#)))
       negative-bars))))
   v17_l164)))
