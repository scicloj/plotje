  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__77838#] (nth waterfall-bars p1__77838#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__77839#] (nth waterfall-bars p1__77839#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__77840#] (= green (:color p1__77840#)))
       positive-bars)
      (every?
       (fn* [p1__77841#] (= red (:color p1__77841#)))
       negative-bars))))
   v17_l164)))
