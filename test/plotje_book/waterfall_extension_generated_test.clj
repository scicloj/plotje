  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__78336#] (nth waterfall-bars p1__78336#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__78337#] (nth waterfall-bars p1__78337#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__78338#] (= green (:color p1__78338#)))
       positive-bars)
      (every?
       (fn* [p1__78339#] (= red (:color p1__78339#)))
       negative-bars))))
   v17_l164)))
