  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__91669#] (nth waterfall-bars p1__91669#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__91670#] (nth waterfall-bars p1__91670#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__91671#] (= green (:color p1__91671#)))
       positive-bars)
      (every?
       (fn* [p1__91672#] (= red (:color p1__91672#)))
       negative-bars))))
   v17_l164)))
