  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__98821#] (nth waterfall-bars p1__98821#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__98822#] (nth waterfall-bars p1__98822#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__98823#] (= green (:color p1__98823#)))
       positive-bars)
      (every?
       (fn* [p1__98824#] (= red (:color p1__98824#)))
       negative-bars))))
   v17_l164)))
