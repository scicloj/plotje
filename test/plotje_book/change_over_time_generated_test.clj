...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__83938#] (Math/sin (* p1__83938# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :sin
    (map (fn* [p1__83939#] (Math/sin (* p1__83939# 0.3))) (range 30)),
    :cos
    (map
     (fn* [p1__83940#] (Math/cos (* p1__83940# 0.3)))
     (range 30))})))
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__83941#] (Math/sin (* p1__83941# 0.3))) (range 30))}
  (pj/lay-area :x :y)))
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__83942#] (re-find #"[A-Z][a-z]{2}" p1__83942#))
       tick-labels))))
   v35_l167)))
