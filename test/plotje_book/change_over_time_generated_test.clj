...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__83898#] (Math/sin (* p1__83898# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :sin
    (map (fn* [p1__83899#] (Math/sin (* p1__83899# 0.3))) (range 30)),
    :cos
    (map
     (fn* [p1__83900#] (Math/cos (* p1__83900# 0.3)))
     (range 30))})))
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__83902#] (re-find #"[A-Z][a-z]{2}" p1__83902#))
       tick-labels))))
   v35_l167)))
