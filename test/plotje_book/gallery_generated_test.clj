...
(def
 ...
 (->
  (rdatasets/gapminder-gapminder)
  (tc/select-rows (fn* [p1__80114#] (= 2007 (:year p1__80114#))))
...
(def
 ...
 (->
  ...
  (tc/select-rows
   (fn*
    [p1__80116#]
    (#{"Houston" "Dallas" "San Antonio" "Austin"} (:city p1__80116#))))
...
(def
 ...
 (->
  (rdatasets/lme4-sleepstudy)
  (tc/select-rows
   (fn* [p1__80117#] (= "308" (str (:subject p1__80117#)))))
...
(def
 ...
 (->
  (tc/select-rows
   (rdatasets/gapminder-gapminder)
   (fn* [p1__80118#] (= 2007 (:year p1__80118#))))
  (pj/lay-point
   :gdp-percap
   :life-exp
   ...
   (tc/add-column
    ...
    (fn
     ...
     (map
      (fn*
       [p1__80119#]
       (get {5 "May", 6 "Jun", 7 "Jul", 8 "Aug", 9 "Sep"} p1__80119#))
      (ds :month)))))))
...
(def
 v321_l1530
 (->
  {:row (mapcat (fn* [p1__80120#] (repeat 6 p1__80120#)) (range 6)),
   :col (flatten (repeat 6 (range 6))),
   :value
   (map (fn* [p1__80121#] (Math/sin (* p1__80121# 0.5))) (range 36))}
...
(def
 ...
 (->
  (tc/select-rows
   (rdatasets/gapminder-gapminder)
   (fn* [p1__80122#] (= 2007 (:year p1__80122#))))
