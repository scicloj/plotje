...
(def
 ...
 (->
  (rdatasets/gapminder-gapminder)
  (tc/select-rows (fn* [p1__84551#] (= 2007 (:year p1__84551#))))
...
(def
 ...
 (->
  ...
  (tc/select-rows
   (fn*
    [p1__84553#]
    (#{"Houston" "Dallas" "San Antonio" "Austin"} (:city p1__84553#))))
...
(def
 ...
 (->
  (rdatasets/lme4-sleepstudy)
  (tc/select-rows
   (fn* [p1__84554#] (= "308" (str (:subject p1__84554#)))))
...
(def
 ...
 (->
  (tc/select-rows
   (rdatasets/gapminder-gapminder)
   (fn* [p1__84555#] (= 2007 (:year p1__84555#))))
  (pj/lay-point
   :gdp-percap
   :life-exp
   ...
   (tc/add-column
    ...
    (fn
     ...
     (map
      (fn*
       [p1__84556#]
       (get {5 "May", 6 "Jun", 7 "Jul", 8 "Aug", 9 "Sep"} p1__84556#))
      (ds :month)))))))
...
(def
 v321_l1530
 (->
  {:row (mapcat (fn* [p1__84557#] (repeat 6 p1__84557#)) (range 6)),
   :col (flatten (repeat 6 (range 6))),
   :value
   (map (fn* [p1__84558#] (Math/sin (* p1__84558# 0.5))) (range 36))}
...
(def
 ...
 (->
  (tc/select-rows
   (rdatasets/gapminder-gapminder)
   (fn* [p1__84559#] (= 2007 (:year p1__84559#))))
