...
(def
 ...
 (->
  (rdatasets/gapminder-gapminder)
  (tc/select-rows (fn* [p1__80132#] (= 2007 (:year p1__80132#))))
...
(def
 ...
 (->
  ...
  (tc/select-rows
   (fn*
    [p1__80134#]
    (#{"Houston" "Dallas" "San Antonio" "Austin"} (:city p1__80134#))))
...
(def
 ...
 (->
  (rdatasets/lme4-sleepstudy)
  (tc/select-rows
   (fn* [p1__80135#] (= "308" (str (:subject p1__80135#)))))
...
(def
 ...
 (->
  (tc/select-rows
   (rdatasets/gapminder-gapminder)
   (fn* [p1__80136#] (= 2007 (:year p1__80136#))))
  (pj/lay-point
   :gdp-percap
   :life-exp
   ...
   (tc/add-column
    ...
    (fn
     ...
     (map
      (fn*
       [p1__80137#]
       (get {5 "May", 6 "Jun", 7 "Jul", 8 "Aug", 9 "Sep"} p1__80137#))
      (ds :month)))))))
...
(def
 v321_l1530
 (->
  {:row (mapcat (fn* [p1__80138#] (repeat 6 p1__80138#)) (range 6)),
   :col (flatten (repeat 6 (range 6))),
   :value
   (map (fn* [p1__80139#] (Math/sin (* p1__80139# 0.5))) (range 36))}
...
(def
 ...
 (->
  (tc/select-rows
   (rdatasets/gapminder-gapminder)
   (fn* [p1__80140#] (= 2007 (:year p1__80140#))))
