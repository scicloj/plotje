...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__88752#] (= 50 (:n-points p1__88752#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__88753#] (< (:lo p1__88753#) (:hi p1__88753#)))
      bars)
     (every? (fn* [p1__88754#] (pos? (:count p1__88754#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__88755#] (Math/sin (* p1__88755# 0.3))) (range 30))}))
