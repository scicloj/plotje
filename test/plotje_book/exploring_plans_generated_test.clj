...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__89925#] (= 50 (:n-points p1__89925#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__89926#] (< (:lo p1__89926#) (:hi p1__89926#)))
      bars)
     (every? (fn* [p1__89927#] (pos? (:count p1__89927#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__89928#] (Math/sin (* p1__89928# 0.3))) (range 30))}))
