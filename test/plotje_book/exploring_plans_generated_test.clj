...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__92293#] (= 50 (:n-points p1__92293#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__92294#] (< (:lo p1__92294#) (:hi p1__92294#)))
      bars)
     (every? (fn* [p1__92295#] (pos? (:count p1__92295#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__92296#] (Math/sin (* p1__92296# 0.3))) (range 30))}))
