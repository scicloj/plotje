...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__95989#] (= 50 (:n-points p1__95989#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__95990#] (< (:lo p1__95990#) (:hi p1__95990#)))
      bars)
     (every? (fn* [p1__95991#] (pos? (:count p1__95991#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__95992#] (Math/sin (* p1__95992# 0.3))) (range 30))}))
