...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__77153#] (= 50 (:n-points p1__77153#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__77154#] (< (:lo p1__77154#) (:hi p1__77154#)))
      bars)
     (every? (fn* [p1__77155#] (pos? (:count p1__77155#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__77156#] (Math/sin (* p1__77156# 0.3))) (range 30))}))
