...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__98152#] (= 50 (:n-points p1__98152#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__98153#] (< (:lo p1__98153#) (:hi p1__98153#)))
      bars)
     (every? (fn* [p1__98154#] (pos? (:count p1__98154#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__98155#] (Math/sin (* p1__98155# 0.3))) (range 30))}))
