...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__96326#] (= 50 (:n-points p1__96326#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__96327#] (< (:lo p1__96327#) (:hi p1__96327#)))
      bars)
     (every? (fn* [p1__96328#] (pos? (:count p1__96328#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__96329#] (Math/sin (* p1__96329# 0.3))) (range 30))}))
