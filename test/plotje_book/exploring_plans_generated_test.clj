...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__91830#] (= 50 (:n-points p1__91830#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__91831#] (< (:lo p1__91831#) (:hi p1__91831#)))
      bars)
     (every? (fn* [p1__91832#] (pos? (:count p1__91832#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__91833#] (Math/sin (* p1__91833# 0.3))) (range 30))}))
