...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__90984#] (= 50 (:n-points p1__90984#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__90985#] (< (:lo p1__90985#) (:hi p1__90985#)))
      bars)
     (every? (fn* [p1__90986#] (pos? (:count p1__90986#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__90987#] (Math/sin (* p1__90987# 0.3))) (range 30))}))
