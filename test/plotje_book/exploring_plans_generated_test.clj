...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__81204#] (= 50 (:n-points p1__81204#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__81205#] (< (:lo p1__81205#) (:hi p1__81205#)))
      bars)
     (every? (fn* [p1__81206#] (pos? (:count p1__81206#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__81207#] (Math/sin (* p1__81207# 0.3))) (range 30))}))
