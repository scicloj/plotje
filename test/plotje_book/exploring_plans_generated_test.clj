...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__88398#] (= 50 (:n-points p1__88398#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__88399#] (< (:lo p1__88399#) (:hi p1__88399#)))
      bars)
     (every? (fn* [p1__88400#] (pos? (:count p1__88400#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__88401#] (Math/sin (* p1__88401# 0.3))) (range 30))}))
