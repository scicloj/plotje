...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__96824#] (= 50 (:n-points p1__96824#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__96825#] (< (:lo p1__96825#) (:hi p1__96825#)))
      bars)
     (every? (fn* [p1__96826#] (pos? (:count p1__96826#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__96827#] (Math/sin (* p1__96827# 0.3))) (range 30))}))
