...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__77539#] (= 50 (:n-points p1__77539#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__77540#] (< (:lo p1__77540#) (:hi p1__77540#)))
      bars)
     (every? (fn* [p1__77541#] (pos? (:count p1__77541#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__77542#] (Math/sin (* p1__77542# 0.3))) (range 30))}))
