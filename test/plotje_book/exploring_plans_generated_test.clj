...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__102329#] (= 50 (:n-points p1__102329#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__102330#] (< (:lo p1__102330#) (:hi p1__102330#)))
      bars)
     (every? (fn* [p1__102331#] (pos? (:count p1__102331#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__102332#] (Math/sin (* p1__102332# 0.3)))
    (range 30))}))
