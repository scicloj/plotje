...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__95263#] (= 50 (:n-points p1__95263#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__95264#] (< (:lo p1__95264#) (:hi p1__95264#)))
      bars)
     (every? (fn* [p1__95265#] (pos? (:count p1__95265#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__95266#] (Math/sin (* p1__95266# 0.3))) (range 30))}))
