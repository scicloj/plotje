...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__89641#] (= 50 (:n-points p1__89641#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__89642#] (< (:lo p1__89642#) (:hi p1__89642#)))
      bars)
     (every? (fn* [p1__89643#] (pos? (:count p1__89643#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__89644#] (Math/sin (* p1__89644# 0.3))) (range 30))}))
