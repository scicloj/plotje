...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__102569#] (= 50 (:n-points p1__102569#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__102570#] (< (:lo p1__102570#) (:hi p1__102570#)))
      bars)
     (every? (fn* [p1__102571#] (pos? (:count p1__102571#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__102572#] (Math/sin (* p1__102572# 0.3)))
    (range 30))}))
