...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__88648#] (= 50 (:n-points p1__88648#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__88649#] (< (:lo p1__88649#) (:hi p1__88649#)))
      bars)
     (every? (fn* [p1__88650#] (pos? (:count p1__88650#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__88651#] (Math/sin (* p1__88651# 0.3))) (range 30))}))
