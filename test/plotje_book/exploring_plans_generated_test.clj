...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__99477#] (= 50 (:n-points p1__99477#))) gs)))
   v49_l175)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__99478#] (< (:lo p1__99478#) (:hi p1__99478#)))
      bars)
     (every? (fn* [p1__99479#] (pos? (:count p1__99479#))) bars)))
   v74_l246)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__99480#] (Math/sin (* p1__99480# 0.3))) (range 30))}))
