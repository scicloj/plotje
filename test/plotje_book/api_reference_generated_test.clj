...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__94320#] (Math/sin (* p1__94320# 0.3))) (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__94322#] (bit-and p1__94322# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__94323#] (bit-and p1__94323# 255)) (vec bs))))))
