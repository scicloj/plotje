...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__75726#] (Math/sin (* p1__75726# 0.3))) (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__75728#] (bit-and p1__75728# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__75729#] (bit-and p1__75729# 255)) (vec bs))))))
