...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__87224#] (Math/sin (* p1__87224# 0.3))) (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__87226#] (bit-and p1__87226# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__87227#] (bit-and p1__87227# 255)) (vec bs))))))
