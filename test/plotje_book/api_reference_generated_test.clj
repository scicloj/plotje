...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__75619#] (Math/sin (* p1__75619# 0.3))) (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__75621#] (bit-and p1__75621# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__75622#] (bit-and p1__75622# 255)) (vec bs))))))
