...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__72451#] (Math/sin (* p1__72451# 0.3))) (range 30))}))
...
(def
 ...
 (let
  [f
   ...
   boxes
   (mapv
    (fn* [p1__72453#] (-> p1__72453# :frames :panel-box))
    (:panels f))
   inside?
   (fn
    [[x y w h]]
  ...
  {:canvas (:canvas f),
   ...
   (mapv
    (fn* [p1__72454#] (vec (keys (:frames p1__72454#))))
    (:panels f))}))
 ...
 (is
  ((fn
    ...
    (and
     ...
     (every?
      (fn* [p1__72455#] (= [:panel-box :drawing-area] p1__72455#))
...
(def
 ...
 (let
  ...
  (->>
   ...
   (mapv (fn* [p1__72456#] (Math/round (double p1__72456#)))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__72457#] (bit-and p1__72457# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__72458#] (bit-and p1__72458# 255)) (vec bs))))))
