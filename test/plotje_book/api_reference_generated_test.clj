...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__78910#] (Math/sin (* p1__78910# 0.3))) (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__78912#] (bit-and p1__78912# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__78913#] (bit-and p1__78913# 255)) (vec bs))))))
