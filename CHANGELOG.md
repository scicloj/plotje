...
- **Every date axis whose ticks step by a whole year or a whole month.** The label carries the unit the ticks step by and nothing finer: fifteen years of January firsts are ticked `2002`, `2004`, `2006` where they read `2002-01`, `2003-01`, `2004-01`, and a year of month starts is ticked `Jan`, `Mar`, `May` where it read `Feb-01`, `Mar-01`, `Apr-01`. The month and the day were the same on every one of those ticks, so they took up room without telling any two apart. ggplot2 labels a span of years the same way; on a span of months it writes the year beside the month, which Plotje leaves off where every tick falls in one year.
